<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zawodnicy.aspx.cs" Inherits="P05AplikacjaZawodnicy.Zawodnicy" %>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <%
                                                for (int i = 0; i < ZawodnicyLista.Length; i++)
                                                { %>
                                            ...
                                            <tr>
                                                ...
                                                <td><%= ZawodnicyLista[i].Waga %>
                                                </td>
                                                <td><%= ZawodnicyLista[i].Wzrost %>
                                                </td>
                                                 <td><%= ZawodnicyLista[i].DataUr.ToShortDateString() %>
                                                </td>
                                            </tr>
